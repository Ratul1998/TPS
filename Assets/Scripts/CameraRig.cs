...
public class CameraRig : MonoBehaviour
{
    ...
    bool fps;
    public static CameraRig GetInstance()
    {
        return instance;
    }
    ...
    public class CameraSettings
    {
        ...
        public Vector3 cameraOffsetMiddle;
    ...
    void Update()
    {
        if (target)
        {
            ...
            if (target.GetComponent<CharecterMovement>().coverSettings.inCover)
            {
                if (target.GetComponent<CharecterMovement>().coverSettings.coverDirection == -1)
                    shoulder = Shoulder.Left;
                else if (target.GetComponent<CharecterMovement>().coverSettings.coverDirection == 1)
    ...
    void CheckWall()
    {
        ...
        else
        {
            ...
            {
                case Shoulder.Left:
                    if(aiming || target.GetComponent<CharecterMovement>().coverSettings.inCover)
                        PostionCamera(cameraSettings.camPositionOffsetLeft);
                    else
                        PostionCamera(cameraSettings.cameraOffsetMiddle);
                    break;
                case Shoulder.Right:
                    if(aiming || target.GetComponent<CharecterMovement>().coverSettings.inCover )
