...
public class AI : MonoBehaviour {
    ...
    private CharecterMovement charecterMove { get { return GetComponent<CharecterMovement>(); } set { charecterMove = value; } }

    private Animator animator { get { return GetComponent<Animator>(); } set { animator = value; } }

    private WeaponHandeler weaponHandeler { get { return GetComponent<WeaponHandeler>(); } set { weaponHandeler = value; } }

    private CharecterStats characterStats { get { if(GetComponent<CharecterStats>()) return GetComponent<CharecterStats>(); return null ; } set { characterStats = value; } }
